      ...
      <div className="StoreMiddleContainer">
        <div className="StoreNavBar">
          ...
          <div>
            ...
            <input type="range" min="3000" onChange={(e)=> setPrice(e.target.value)} max="500000" class="slider" id="myRange" />
            <div>The Selected Price Range is</div>
            <div>0 - {price}</div>
            </div>
            <h3 className="my-4">Colour</h3>
            <div className="coloor whiteColoor">
            </div>
            <div className="coloor blackColoor">
            </div>
            <div className="coloor redColoor">
            </div>
            <div className="coloor greenColoor">
            </div>
            <div className="coloor blueColoor">
            </div>
            <div className="more">
MORE
            </div>
